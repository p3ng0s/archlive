...
"  <Leader>v       -> open netrw
"  <Leader>ga      -> open git add .
"  <Leader>gc      -> open git commit
"  <Leader>gp      -> open git push
...
if has("gui_running")
	highlight Normal guibg=#282c34  " Set background color (example: dark gray)
endif
...
let g:blog_url = "https://leosmith.wtf/blog/"

let g:xss_bomb_url = "https:/localhost:8000"
"let g:xss_bomb_url = "https:/leosmith.wtf:8000"
...
nnoremap <Leader>ga <Esc>:G add .<CR>
vnoremap <Leader>ga <Esc>:G add .<CR>
nnoremap <Leader>gc <Esc>:G commit<CR>
vnoremap <Leader>gc <Esc>:G commit<CR>
...
nnoremap <Leader>gp <Esc>:G push<CR>
vnoremap <Leader>gp <Esc>:G push<CR>
